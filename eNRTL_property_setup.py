...
_inherent_rxn_dict = {
    ...
    ("H2O", "CO2", "MEA"): {
        "MEA_carbamate_formation_combo": {
            ...
            "parameter_data": {
                "k_eq_coeff": {
                    # "1": (318.8, pyunits.dimensionless),
                    # "2": (671.6, pyunits.K),
                    # "3": (-56.9, pyunits.dimensionless),
                    # "4": (.0702, 1 / pyunits.K),
                    "1": (233.4, pyunits.dimensionless),
                    "2": (-3410, pyunits.K),
                    "3": (-36.8, pyunits.dimensionless),
                    "4": (0.0, 1 / pyunits.K),
                }
            }
        },
        "MEA_bicarbonate_formation_combo": {
            ...
            "parameter_data": {
                "k_eq_coeff": {
                    # "1": (549.3, pyunits.dimensionless),
                    # "2": (-11109.3, pyunits.K),
                    # "3": (-94.1, pyunits.dimensionless),
                    # "4": (.1118, 1 / pyunits.K),
                    "1": (176.72, pyunits.dimensionless),
                    "2": (-2909, pyunits.K),
                    "3": (-28.46, pyunits.dimensionless),
                    "4": (0.0, 1 / pyunits.K),
                }
            }
        },
...
_parameter_data = {
    ...
    "Liq_tau_A": {
        ...
        ("MEA", "H2O"): 1.5201,
        ("H2O", "MEA"): 0.1559,
        # ("H2O", "MEAH^++, MEACOO^-"): 18.588108594566588,
        # ("H2O", "MEAH^++, HCO3^-"): 8.5721,
        # ("MEAH^+, MEACOO^-", "H2O"): -7.055694714651596,
        # ("MEAH^+, HCO3^-", "H2O"): -4.0092,
        # ("MEA", "MEAH^+, MEACOO^-"): 8,
        # ("MEA", "MEAH^+, HCO3^-"): 8,
        # ("CO2", "MEAH^+, MEACOO^-"): 8,
        # ("CO2", "MEAH^+, HCO3^-"): 8,
    ...
    "Liq_tau_B": {
        ...
        ("MEA", "H2O"): -910.30,
        ("H2O", "MEA"): 110.80,
        # ("H2O", "MEAH^+, MEACOO^-"): -1533.6489230168652,
        # ("H2O", "MEAH^+, HCO3^-"): 0,
        # ("MEAH^+, MEACOO^-", "H2O"): 1224.0939968361579,
        # ("MEAH^+, HCO3^-", "H2O"): 0,
        # ("MEA", "MEAH^+, MEACOO^-"): 0,
        # ("MEA", "MEAH^+, HCO3^-"): 0,
        # ("CO2", "MEAH^+, MEACOO^-"): 0,
...
# rxn_combinations = {
#     "MEA_bicarbonate_formation_combo": {"bicarbonate_formation": 1, "MEA_protonation": 1},
...
def get_prop_dict(components=None):
    ...
    configuration = {
        ...
        "state_bounds": {
            ...
            "pressure": (5e2, 101325, 2e7, pyunits.Pa),
        },
